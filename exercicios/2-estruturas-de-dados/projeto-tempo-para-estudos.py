...
print(f'Olá  {nome}, você costuma estudar {total_dias} por semana, durante mais ou menos {total_horas} diarias. isso significa que você estuda em média {total_dias*total_horas} horas por semana para o curso {curso}')